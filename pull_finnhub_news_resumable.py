...
if not FINNHUB_TOKEN:
    sys.exit("ERROR: Set FINNHUB_TOKEN (PowerShell):  setx FINNHUB_TOKEN \"your_key\"  and reopen terminal.")

HIGH_CATALYST_30 = [
    "NVDA","AVGO","AMD","SMCI","MU","TSM","ARM","ASML","ACLS","AEHR","NVTS",
    "SNOW","DDOG","PLTR","NET","MDB","PATH","S","IOT",
    "MRNA","BMRN","REGN","VRTX","EXAS",
    "LMT","NOC","RTX","LHX","RKLB","ASTS"
]
...
def parse_args():
    ...
    p.add_argument("--universe", choices=["high","utilities"], default="high",
                   help="Which preset ticker universe to use.")
    ...
    p.add_argument("--outdir", default="data/news_raw", help="Output dir per-ticker CSVs.")
...
def main():
    args = parse_args()
    tickers = HIGH_CATALYST_30 if args.universe == "high" else UTILITIES_20
